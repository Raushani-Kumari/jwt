...
export default function Signup({ setShowModalContent, isModel }) {
  ...
  const renderSignupForm = (
    <div className={!isModel && "form"} style={{ ...(!isModel && formStyle) }}>
      <Form className="create-form" onSubmitCapture={handleSignupData}>
        ...
        <div style={{ textAlign: "center", marginTop: "16px" }}>
          <span>
            New User?
            <Button type="text" onClick={handleLoginModal}>
              Log In
            </Button>
          </span>
        </div>
